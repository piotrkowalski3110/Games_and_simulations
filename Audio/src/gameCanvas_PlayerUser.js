    ...
    update(adElapsedTime, aTiles) {
        ...
        if (0 < Math.abs(adDeltaY)) {
            for (let i = 0; i < anTiles; ++i) {
                ...
                const avSegmentY = getSegmentsIntersection(akvBoundingBox_Tile.yTop, akvBoundingBox_Tile.yBottom, akvBoundingBox_new.yTop, akvBoundingBox_new.yBottom);
                let adCorrY;
