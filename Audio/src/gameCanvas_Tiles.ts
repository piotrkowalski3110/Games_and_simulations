...
class TilesType {
    ...
    constructor(akvOptionsIn: MyTilesOptions) {
        ...
        if (Array.isArray(aMapTiles)) {
            ...
            let anRow: number, anCol: number, anRows: number, anCols: number, avLine: number[], aTile: PlayerType,
                anTileIndex: number;
    ...
    getCollidingTiles(akvBoundingBox: BoundingBox): PlayerType[] {
        ...
        const avSegmentX: Segment = getSegmentsIntersection(akvBoundingBox.xLeft, akvBoundingBox.xRight, this.kvBoundingBox.xLeft, this.kvBoundingBox.xRight);
        const avSegmentY: Segment = getSegmentsIntersection(akvBoundingBox.yTop, akvBoundingBox.yBottom, this.kvBoundingBox.yTop, this.kvBoundingBox.yBottom);
