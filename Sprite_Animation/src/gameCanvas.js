...
function onReady() {
    ...
    const aAnimStandMusketeerPlayer = new AnimationType({ strURL: "images/Musketeer_Idle.png", context: aContext, nRate: 300 });
    const aAnimStandEnemyKnightEnemy = new AnimationType({ strURL: "images/Knight_Idle.png", context: aContext, nRate: 300 });
